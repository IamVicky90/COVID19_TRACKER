...
class COVID19_TRACKER:
    ...
    def tracker(self):
        d=datetime.datetime.now(datetime.timezone(datetime.timedelta(seconds=18000), 'Pakistan Standard Time'))
        ...
        self.draw_figures_obj.lineplot(df1['Last_Update'],df1['Cases in a day'],title='COVID19 SITUATION IN PAKSITAN FROM 2021',legend='Total Cases since 2021: '+str(int(sum)),color='g')
        self.draw_figures_obj.lineplot(df1['Last_Update'],df1['Deaths in a day'],title='COVID19 Deaths IN PAKSITAN FROM 2021',legend='Total Deaths since 2021: '+str(int(death_sum)),color='r')
        self.draw_figures_obj.lineplot(df1['Last_Update'],df1['Recovered in a day'],title='COVID19 Recoveries IN PAKSITAN FROM 2021',legend='Total Recoveries since 2021: '+str(int(recovered_sum)),color='b')
